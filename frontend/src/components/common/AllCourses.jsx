   ...
   return (
      <>
         <div className=" mt-4 filter-container text-center" >
            <p className="mt-3" style={{color:"#eeee",fontWeight:"bold"}}>Search By: </p>
            <input
               type="text"
               placeholder="Title"
               value={filterTitle}
               ...
               allCourses
                  ...
                  .map((course, index) => (
                     <div key={course._id} className='course'>
                        <div className="card1">
                           <div className="desc" style={{backgroundColor:"#eeee"}}>
                              <h3>Modules</h3>
                           ...
                           <div className="details">
                              <div className="center">
                                 <h1>
                                    {course.C_title}<br /><br/>
                                    <span>{course.C_categories}</span><br /><br/>
                                    <span style={{ fontSize: 10 }}>by: &nbsp;{course.C_educator}</span>
                                 </h1>

                                 <b><p>Sections: {course.sections.length}</p>
                                 <p>Price(Rs.): {course.C_price}</p>
                                 <p>Enrolled students: {course.enrolled}</p></b>
                                 {user.userLoggedIn === true ?
                                    <>
                                       <Button
                                          className="btn-startcourse"
                                       ...
                                       <Modal show={showModal[index]} onHide={() => handleClose(index)}>
                                          <Modal.Header closeButton style={{backgroundColor:"#134B70",color:"white"}}>
                                             <Modal.Title>
                                                Payment for {course.C_title} Course
                                             </Modal.Title>

                                          </Modal.Header>
                                          <Modal.Body style={{color:"#134B70",fontWeight:"500"}}>
